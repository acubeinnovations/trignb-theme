...
<!--<div class="header-container">
 ...
 <!--SLIDE SHOW STARTS HERE -->
  <div class="slideshow-wrap">
	 	  ...
	 	  <img class="responsive" src="sites/all/themes/Biolerplate/img/advertising-background.png" width="100%"/>
 ...
 <!--SLIDE SHOW ENDS HERE --> 
  ...
  <!--CONTACT FORM STARTS HERE -->
	   ...
	   <div class="advertising-page-top-wrapper">
	    <div class="advertising-page-top-block-wrapper">
		   <div class="advertising-page-top-block-left"><?php print render($page['advertising-page-top-block-left']); ?></div>
		   <div class="advertising-page-top-block-right"><?php print render($page['advertising-page-top-block-right']); ?></div>
		</div>    
	   </div>
	   <div class="advertising-page-bottom-wrapper">
	     <div class="advertising-page-bottom-block-wrapper">
	   		<div class="advertising-page-bottom-block-header"><?php print render($page['advertising-page-bottom-block-header']); ?></div>
			<div class="advertising-page-bottom-block-left"><?php print render($page['advertising-page-bottom-block-left']); ?></div>
			<div class="advertising-page-bottom-block-right"><?php print render($page['advertising-page-bottom-block-right']); ?></div>
			<div class="advertising-page-bottom-block-footer"><?php print render($page['advertising-page-bottom-block-footer']); ?></div>
		 </div>	
	   </div>
      </div>
