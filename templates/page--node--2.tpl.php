...
<!--<div class="header-container">
 ...
 <!--SLIDE SHOW STARTS HERE -->
  <div class="slideshow-wrap">
	 	  ...
	 	  <img class="responsive" src="sites/all/themes/Biolerplate/img/Radio-stations-top-slider.png" width="100%"/>
...
<!--  <div class="radio-station-wrapper">
     <div class="radio-station-block-wrapper">
	    <div class="radio-station-block-left">
		   <?php// print render($page['radio-station-block-left']); ?>
		</div>
		<div class="radio-station-block-right">
		   <?php// print render($page['radio-station-block-right']); ?>
		</div>
	 </div>
	 <div class="radio-station-block-seperator">
	 </div>
  </div>-->	  
<div class="radio-station-wrapper">
  <div class="radio-station-main">
  	<?php print render($page['radio-station-main']); ?>
  </div>
</div>	 
